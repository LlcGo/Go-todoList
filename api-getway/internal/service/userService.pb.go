...
const file_userService_proto_rawDesc = "" +
	"\n" +
	"\x11userService.proto\x12\x02pb\x1a\x0fuserModel.proto\"\x8b\x01\n" +
	...
	"\n" +
	"UserLogout\x12\x0f.pb.UserRequest\x1a\x16.pb.UserDetailResponseB\x17Z\x15/internal/logic;logicb\x06proto3"
...
var file_userService_proto_depIdxs = []int32{
	2, // 0: pb.UserDetailResponse.UserDetail:type_name -> UserModel
